...
class SpERT(BertPreTrainedModel):
    ...
    def _classify_relations(self, entity_spans, size_embeddings, 
        ...
        entity_pairs1_pro = self.projection_entity(entity_pairs1)
        ...
        rel_local_ctx, attn_output_weights = multihead_attn(entity_pairs1_pro, rel_ctx_pro, rel_ctx_pro)
        full_local_ctx, attn_output_weights = multihead_attn(entity_pairs1_pro, full_ctx_pro, full_ctx_pro)
        ...
        rel_repr = torch.cat([rel_repr, rel_repr2], dim=2)
