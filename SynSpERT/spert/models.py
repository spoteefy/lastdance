...
class SpERT(BertPreTrainedModel):
    ...
    def _classify_relations(self, entity_spans, size_embeddings, 
        ...
        multihead_attn = torch.nn.MultiheadAttention(2304, 16)
        ...
        rel_repr, attn_output_weights = multihead_attn(rel_repr, rel_repr, rel_repr)
        rel_repr = torch.cat([rel_repr, size_pair_embeddings], dim=2)
